<div class="serviceProducts form">
	...
	<div class="row">
		...
		<div class="col_6 pull-right" id="right-serv">
			<?php
				...
				if(!empty($id)){
					echo $this->Form->input('release_date', array('type' => 'text', 'class' => 'form-control', 'label' => 'Datum', 'id' => 'datepicker', 'class' => 'date form_datetime'));
				}
				echo $this->Form->input('for_distributors', array('label' => 'Za distributere'));
				echo $this->Form->input('service_status', array('id' => 'status', 'class' => 'form-control', 'label' => 'Za Status', 'empty' => '-Izaberi-','options' => $statuses));
